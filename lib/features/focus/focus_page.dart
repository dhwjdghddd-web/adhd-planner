    ...
    return LayoutBuilder(
      builder: (context, constraints) {
        final illustrationSize = math
            .min(220.0, constraints.maxHeight * 0.28)
            .clamp(140.0, 220.0);
                  ...
                  center: Column(
                    ...
                    children: [
                      Icon(
                        ...
                        size: (illustrationSize * 0.16).clamp(24.0, 34.0),
                        color: theme.colorScheme.primary,
                      ),
                      ...
                      ConstrainedBox(
                        constraints: BoxConstraints(
                          maxWidth: (illustrationSize * 0.6).clamp(90.0, 140.0),
                        ),
                        child: Text(
                          segment.name,
        ...
        // Keep the header fixed while only the checklist scrolls if there's
        // sufficient remaining room for at least a couple checklist items.
        // Otherwise, fall back to scrolling header + checklist together.
        final fixedHeaderMinHeight = illustrationSize + 360.0;
